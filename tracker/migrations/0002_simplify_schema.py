...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['telegram_id', '-transaction_date'], name='tracker_tran_telegramid_idx'),
        ),
        migrations.AddIndex(
            model_name='transaction',
            index=models.Index(fields=['telegram_id', 'transaction_type'], name='tracker_tran_type_idx'),
        ),
    ]
